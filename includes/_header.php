...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_POST["Correo"] == $correo_correcto && $_POST["Contraseña"] == $contrasena_correcta) {
...
<body>
    ...
    <div id="wrapper">
        ...
        <ul class="nav-left navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="bak-nav sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="producto_registrar.php">
                    <span class="material-icons">pattern</span>
                    <span class="nav-tex" >Productos</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="registrarProveedor.php">
                    <span class="material-icons">pattern</span>
                    <span>Proveedores</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="cliente_registrar.php">
                    <span class="material-icons">pattern</span>
                    <span>Clientes</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="venta_registrar.php">
                    <span class="material-icons">pattern</span>
                    <span>Ventas</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="historias_registrar.php">
                    <span class="material-icons">pattern</span>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="generar_informes.php">
                    <span class="material-icons">pattern</span>
                    <span>Informes</span>
                </a>
            </li>
